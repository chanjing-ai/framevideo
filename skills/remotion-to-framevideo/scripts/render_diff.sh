...
#
# The eval primitive for the remotion-to-framevideo skill: given a Remotion
# render and a FrameVideo render of the same composition, report whether the
...
# the orchestrator). Override with R2FV_SSIM_THRESHOLD=0.95 in the environment.

set -euo pipefail

THRESHOLD="${R2FV_SSIM_THRESHOLD:-0.85}"
