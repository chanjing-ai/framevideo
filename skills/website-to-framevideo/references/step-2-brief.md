...
**First, scan the Table of Contents in [capabilities.md](capabilities.md)** — the 24-row TOC tells you everything FrameVideo can do. You need this to tell users what's possible. Deep-dive specific sections only if a beat needs them.
