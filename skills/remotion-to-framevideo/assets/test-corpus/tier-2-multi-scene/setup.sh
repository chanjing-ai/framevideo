...
#
# Both Remotion and FrameVideo variants need a 200x200 blue PNG and a
...
mkdir -p "$THIS_DIR/remotion-src/public" "$THIS_DIR/fv-src/assets"
...
cp "$THIS_DIR/remotion-src/public/square.png" "$THIS_DIR/fv-src/assets/square.png"
...
cp "$THIS_DIR/remotion-src/public/music.wav" "$THIS_DIR/fv-src/assets/music.wav"

echo "generated:"
ls -la "$THIS_DIR/remotion-src/public/" "$THIS_DIR/fv-src/assets/"
