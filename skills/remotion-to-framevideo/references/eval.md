...
cd .. && node ../../../packages/cli/dist/cli.js render fv-src/ --output fv.mp4
# -> fv.mp4
...
../../scripts/frame_strip.sh ./remotion-src/out/baseline.mp4 ./fv.mp4 ./strip 8
# -> strip/strip.png
```
...
| `threshold`   | from `R2FV_SSIM_THRESHOLD` env var (default 0.85)                           |
