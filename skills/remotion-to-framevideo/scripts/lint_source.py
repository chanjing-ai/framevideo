#!/usr/bin/env python3
"""Lint a Remotion project for patterns that don't translate cleanly to FrameVideo.
...
RULES: list[Rule] = [
    Rule(
        ...
        "useState detected — Remotion compositions that drive animation via React state are not deterministic frame-capture targets in FrameVideo",
