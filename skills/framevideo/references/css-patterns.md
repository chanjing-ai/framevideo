...
Pure CSS + GSAP implementations of all five MarkerHighlight.js drawing modes. Use these for deterministic rendering in FrameVideo compositions — no external library dependency, full GSAP timeline control.
