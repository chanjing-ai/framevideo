...
**CSS transitions** — 30+ patterns across 13 categories. Full code in `skills/framevideo/references/transitions/`. Pick based on the energy and feel:
...
**Shader transitions** — 14 built-in WebGL GPU effects. Install with `npx framevideo add <name>`. Full API in shader-transitions docs.
