...
`fv-src/assets/x`. Multiple files can be batched with a setup script;
...
[framevideo-vs-remotion.mdx](https://github.com/chanjing/framevideo/blob/main/docs/guides/framevideo-vs-remotion.mdx)
for details.
...
Drop. HF waits on asset readiness via the [Frame Adapter pattern](https://framevideo.chanjing.com/concepts/frame-adapters)
